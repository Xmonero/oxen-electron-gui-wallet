    ...
    <q-layout>
      ...
      <q-page-container class="detail-page">
        <div class="layout-padding">
          ...
          <p class="break-all">{{ node.masternode_pubkey }}</p>
          ...
          <div class="info row justify-between">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatQuenero :amount="node.staking_requirement" raw-value
                  /></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatQuenero :amount="node.total_contributed" raw-value
                  /></span>
                </div>
              </div>
            </div>
          ...
          <q-list no-border :dark="theme == 'dark'" class="quenero-list">
            ...
            >
              <q-item-label>
                ...
                <q-item-label class="non-selectable" caption>
                  ...
                  <FormatQuenero :amount="contributor.amount" raw-value />
                </q-item-label>
              </q-item-label>
              <ContextMenu
  ...
  methods: {
    ...
    openExplorer() {
      this.$gateway.send("core", "open_explorer", {
        type: "masternode",
        id: this.node.masternode_pubkey
      });
    },
