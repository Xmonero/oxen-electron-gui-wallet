<template>
  <div class="column wallet-info">
    ...
    <div class="wallet-content quenero-navy">
      <div class="row justify-center">
        <div class="funds column items-center">
          <div class="balance">
            ...
            <div class="value">
              <span><FormatQuenero :amount="info.balance"/></span>
            </div>
          </div>
          <div class="row unlocked">
            <span
              >{{ $t("strings.queneroUnlockedShort") }}:
              <FormatQuenero :amount="info.unlocked_balance"
            /></span>
          </div>
        </div>
      </div>
