    ...
    <div class="q-pa-md">
      ...
      <div v-else>
        ...
        <div class="row justify-between items-end">
          <QueneroField :label="$t('fieldLabels.data')">
            <q-input
              v-model.trim="toSign"
              :dark="theme == 'dark'"
              borderless
      ...
      <div class="justify-between items-end">
        <QueneroField class="q-mt-md" :label="$t('fieldLabels.signature')">
          <q-input
        ...
        <QueneroField class="q-mt-md" :label="$t('fieldLabels.data')">
          <q-input
        ...
        <QueneroField class="q-mt-md" :label="$t('fieldLabels.address')">
          <q-input
