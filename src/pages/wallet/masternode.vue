...
<script>
import ServiceNodeStaking from "components/masternode/masternode_staking";
import ServiceNodeRegistration from "components/masternode/masternode_registration";
import ServiceNodeUnlock from "components/masternode/masternode_unlock";
export default {
  components: {
    ServiceNodeStaking,
